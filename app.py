...
# Load API keys and configuration from environment (API_Keys.txt)
...
app = Flask(__name__)
# Configure rate limiting: maximum 2 requests per minute per IP:contentReference[oaicite:2]{index=2}
